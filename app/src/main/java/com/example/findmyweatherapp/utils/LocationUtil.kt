package com.campuswatch.helper.util
...
class LocationFetchUtil(
    ...
    //private val nwService = EntryPointAccessors.fromApplication(activity, NwService::class.java)
...
//        if (nwService.nwUtil().isInFlightMode())
